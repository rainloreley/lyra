                    ...
                    <div className={"mt-4"}>
                        <ul className={"flex flex-col"}>
                            {sidebarItems.map((item) => (
                                <button key={item.id}
                                        className={`mx-2 h-8 py-1 text-left mb-2 flex items-center rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 ${selectedItem === item.id ? "bg-gray-100 dark:bg-gray-700" : ""}`}
                                        onClick={() => {
