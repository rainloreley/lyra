...
const DeviceConfigPage: NextPage = () => {
    ...
    useEffect(() => {
        ...
        if (
            ...
            const device = projectManager.currentProject?.devices.find(
                (e) => e.id === deviceId
            );
            if (device === undefined) {
                router.push('/');
    ...
    const saveDevice = () => {
        ...
        if (
            ...
            const index = projectManager.currentProject!.devices.findIndex(
                (e) => e.id === deviceId
            );
            if (index !== -1) {
                ...
                setProjectManager((e) => {
                    // remove device
                    e.currentProject?.devices.splice(index, 1);
                    e.currentProject?.devices.push(deviceInfoCopy);
            ...
            {deviceInfo === null ? (
                ...
                <div className="m-8">
                    ...
                    <div className="mt-4">
                        ...
                        <div className={"mt-6"}>
                            <button
                                className={`p-2 px-4 ${showDeleteConfirmation ? "bg-red-800" : "bg-red-500"} rounded-xl text-white`}
                                onClick={() => {
